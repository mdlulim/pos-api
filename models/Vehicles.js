...
VehiclesModel.prototype.addVehicle = function(vehicle, reply) {
    ...
    var columns    = `customer_id,driver_name,drivers_license,reg_number,make,model,style,colour,vin_number,options,date_added`;
    var values     = `${vehicle.customer_id},'${vehicle.driver_name}','${vehicle.drivers_license}','${vehicle.reg_number}','${vehicle.make}','${vehicle.model}','${style}','${vehicle.colour}','${vin_number}','${options}', NOW()`;
